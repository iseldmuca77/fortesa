/**
 * Thin-line icons (24x24, stroke = currentColor) in the style of the
 * business card artwork. Usage: <CameraIcon className="h-6 w-6" />
 */
const BASE = {
...
function Icon({ className = "h-6 w-6", children }) {
  return (
...
/** Parking: a P inside a rounded square. */
...
/** Automatic gate: rails between two posts, with a remote signal above. */
export function GateIcon(props) {
  return (
    <Icon {...props}>
      ...
      <path d="M9 13v5" />
      <path d="M15 13v5" />
      <path d="M9.5 7a3.5 3.5 0 0 1 5 0" />
      <path d="M7 4.5a7 7 0 0 1 10 0" />
    </Icon>
  );
}
...
/** Keys match the `icon` field of each entry in lib/site.js SERVICES. */
